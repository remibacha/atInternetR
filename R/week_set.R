#' @title Get Weekly AT Internet Data - Set Period
#' @description This function allows you to get weekly data from 'AT Internet' using set perdiod, with a start date and an end date.
...
#'
#' @return week_set extract the data you need from 'AT Internet' database, according to parameters you entered and then provides a dataset.
#'
#' @import httr
#' @import data.table
#'
...
week_set <- function(ATuser, ATpassword, space, start_date, end_date, dim_source = NULL, dim_device = NULL, dim_level2 = NULL, segment = NULL, pagination=1){
